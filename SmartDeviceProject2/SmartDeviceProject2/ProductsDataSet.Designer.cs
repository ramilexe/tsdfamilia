...
namespace Familia.TSDClient.ProductsDataSetTableAdapters {
    ...
    public partial class ProductsTblTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT [Barcode], [ProductName], [Article], [Country], [NavCode], [Structure], [O" +
                "ldPrice], [NewPrice], [TransferDate], [ReturnDate], [PurchasePrice], [ProjectNum" +
                "ber], [DiscountRate] FROM [ProductsTbl]\r\nwhere [Barcode] = @Barkod";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@Barkod", global::System.Data.SqlDbType.NVarChar, 13, global::System.Data.ParameterDirection.Input, true, 0, 0, "Barcode", global::System.Data.DataRowVersion.Current, null));
        }
        ...
        public virtual int FillByBarcode(ProductsDataSet.ProductsTblDataTable dataTable, string Barkod) {
        ...
        public virtual ProductsDataSet.ProductsTblDataTable GetDataByBarcode(string Barkod) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Barkod == null)) {
                throw new global::System.ArgumentNullException("Barkod");
            }
