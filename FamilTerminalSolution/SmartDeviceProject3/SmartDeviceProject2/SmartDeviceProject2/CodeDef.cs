...
namespace TSDUtils
{
    ...
    public enum ActionCode : byte
    {
        ...
        /// <summary>
        /// Машины 
        /// Все машины: тип = 9, NavCode= 13-ти значный код Машины (Номер авто в верхнем регистре), DocId = ШтрихКод ТТН).
        /// </summary>
        Cars = 9,
        ...
        /// <summary>
        /// Накладные и короба
        /// Накладные - короба: NavCode = 13ти зн. Код короба, DocId = номер накладной, 
        ...
        /// <summary>
        /// Машины и короба
        /// NavCode =  13-ти зн. Код короба, DocId = Штрихкод машины, тип документа = 12 – машины и короба.
        /// </summary>
        CarsBoxes = 12,
        ...
        /// <summary>
        /// Короба и товары возвратов
        /// Короба с товарами: тип 15, NavCode= NavCode товара, DocId = ШК короба
        /// </summary>
        ReturnBoxWProducts = 15,

        /// <summary>
        /// Накладные и короба возвратов
        /// Накладные - короба: NavCode = 13ти зн. Код короба, DocId = номер накладной, 
        /// тип документа = 16 – накладные с коробами.
        /// </summary>
        BoxReturns = 16,

        /// <summary>
        /// Закрытие короба возвратов
        /// </summary>
        CloseBoxReturns = 17,

        /// <summary>
        /// Накладные возвратов
        /// Накладные NavCode = 13ти зн. ШК накладной, DocId = номер накладной, 
        /// тип документа = 17 – накладные возвратов.
        /// </summary>
        ReturnsTTN = 18,
    ...
    public class ActionCodeDescription
    {
        ...
        private ActionCodeDescription()
        {
            ...
            dict.Add(ActionCode.ReturnBoxWProducts, "Короба и товары возвратов");
            dict.Add(ActionCode.BoxReturns, "Накладные и короба возвратов");
            dict.Add(ActionCode.CloseBoxReturns, "Закрытие короба возвратов");
            dict.Add(ActionCode.ReturnsTTN, "Накладные возвратов");
